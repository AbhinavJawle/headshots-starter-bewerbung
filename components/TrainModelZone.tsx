    ...
    <>
      ...
      <div className="bg-white rounded-lg">
        <Form {...form}>
          <form
            onSubmit={form.handleSubmit(onSubmit)}
            className="rounded-md flex flex-col gap-6"
          >
            {/* Name Field */}
            <FormField
              control={form.control}
              ...
              render={({ field }) => (
                <FormItem className="w-full rounded-md">
                  ...
                  <FormControl>
                    <Input
                      placeholder="z.B. Natalie Headshots"
                      {...field}
                      className="max-w-screen-sm border border-gray-300 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all duration-200"
                      autoComplete="off"
                    />
                  </FormControl>
            ...
            <div className="flex flex-col gap-3">
              ...
              >
                <div>
                  ...
                  <Label
                    htmlFor="man"
                    className="flex flex-col items-center justify-between rounded-md border-2 border-gray-200 bg-transparent p-4 hover:bg-blue-50 hover:border-blue-300 transition-all duration-200 peer-data-[state=checked]:border-blue-500 peer-data-[state=checked]:bg-blue-50 [&:has([data-state=checked])]:border-blue-500"
                  >
                    <FaMale className="mb-3 h-6 w-6 text-blue-600" />
                    Mann
                  </Label>
                </div>
                ...
                <div>
                  ...
                  <Label
                    htmlFor="woman"
                    className="flex flex-col items-center justify-between rounded-md border-2 border-gray-200 bg-transparent p-4 hover:bg-pink-50 hover:border-pink-300 transition-all duration-200 peer-data-[state=checked]:border-pink-500 peer-data-[state=checked]:bg-pink-50 [&:has([data-state=checked])]:border-pink-500"
                  >
                    <FaFemale className="mb-3 h-6 w-6 text-pink-600" />
                    Frau
                  </Label>
                </div>
                {/* <div>
                  ...
                  <Label
                    htmlFor="person"
                    className="flex flex-col items-center justify-between rounded-md border-2 border-gray-200 bg-transparent p-4 hover:bg-purple-50 hover:border-purple-300 transition-all duration-200 peer-data-[state=checked]:border-purple-500 peer-data-[state=checked]:bg-purple-50 [&:has([data-state=checked])]:border-purple-500"
                  >
                    <FaRainbow className="mb-3 h-6 w-6 text-purple-600" />
                    Unisex
                  </Label>
                </div> */}
              </RadioGroup>
            ...
            <div {...getRootProps()} className="rounded-lg mt-2 cursor-pointer">
              <FormLabel className="font-medium text-gray-700">
                Bilder
              </FormLabel>
              ...
              <div
                className={`outline-dashed outline-2 ${
                  isDragActive
                    ...
                    : "outline-gray-200 hover:outline-blue-400 hover:bg-gray-50"
                } 
                              w-full rounded-lg p-8 flex justify-center align-middle transition-all duration-200`}
              >
                <input {...getInputProps()} />
                {isDragActive ? (
                  <p className="self-center font-medium text-blue-600">
                    Lassen Sie die Dateien hier fallen ...
                  </p>
                ) : (
                  <div className="flex justify-center flex-col items-center gap-3 py-6">
            ...
            {files.length > 0 && (
              <div className="flex flex-row gap-4 flex-wrap mt-2 bg-gray-50 p-4 rounded-lg border border-gray-200">
                {files.map((file) => (
                  <div key={file.name} className="flex flex-col gap-1">
                    <div className="relative">
                      <img
                        src={URL.createObjectURL(file)}
                        className="rounded-md w-24 h-24 object-cover border-2 border-gray-200 shadow-sm hover:border-blue-400 transition-all duration-200"
                        alt="Preview"
                      />
                      <Button
                        variant="outline"
            ...
            {/* Submit Button - Keeping original styling as requested */}
            <Button
              type="submit"
              className="w-full"
              disabled={isLoading}
            ...
            {/* Info Text */}
            <div className="text-center text-gray-500 text-sm space-y-1 mt-2">
              <p>Der Upload braucht ~20 Sekunden.</p>
              <p>Ihre Fotos werden gelöscht sobald der Prozess fertig ist.</p>
            </div>
          </form>
        </Form>
      </div>
